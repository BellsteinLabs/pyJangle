...
COMMITTED_EVENT_QUEUE_SIZE = int(
    os.getenv("JANGLE_COMMITTED_EVENT_QUEUE_SIZE", "200"))
...
async def begin_processing_committed_events():
    ...
    log(LogToggles.event_dispatcher_ready,
        "Event dispatcher ready to process events")
    while True:
