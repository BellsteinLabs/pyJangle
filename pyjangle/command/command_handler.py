...
def handle_command(command: Command, dispatch_new_events_locally: bool = True) -> CommandResponse:
    ...
    while True:
        ...
        log(LogToggles.retrieved_aggregate_events, "Retrieved aggregate events", {"aggregate_id": aggregate_id, "aggregate_type": str(type(aggregate)), "event_count": len(events)})
