...
NAME_TO_EVENT_TYPE_MAP = "pyjangle.event.register_event.__name_to_event_type_map"
...
EVENT_ID_FACTORY = "pyjangle.event.register_event_id_factory.__event_id_factory"
